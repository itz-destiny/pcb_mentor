...
const Hero = () => {
  return (
    <section className="flex flex-col md:flex-row bg-[var(--color-background)] w-full items-center justify-center px-4 sm:px-6 lg:px-8 py-8">
      <div className="w-full max-w-[565px] flex flex-col justify-start items-start gap-6">
        ...
        <div className="p-2.5 flex justify-start items-start">
